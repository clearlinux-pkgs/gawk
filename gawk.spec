...
Version  : 5.3.1
Release  : 69
URL      : https://mirrors.kernel.org/gnu/gawk/gawk-5.3.1.tar.gz
Source0  : https://mirrors.kernel.org/gnu/gawk/gawk-5.3.1.tar.gz
Source1  : https://mirrors.kernel.org/gnu/gawk/gawk-5.3.1.tar.gz.sig
...
cd %{_builddir}/gawk-5.3.1
pushd ..
cp -a gawk-5.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726678535
